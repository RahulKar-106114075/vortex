...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 10, 2017 at 08:19 PM
...
INSERT INTO `registration` (`email`, `password`, `repassword`, `username`, `fullname`, `sex`, `college`, `degree`, `year`, `branch`, `phone`, `address`, `city`, `state`) VALUES
('', '', '', '', '', '', '', '', 0, '', 0, '', '', ''),
